...
原始音频本机处理，云翻译只发送文字。播放地址、历史和云密钥不持久保存；缓冲偏好及更新偏好保存在本机。全屏和已存在的小窗能力沿用现状。Chrome 扩展不在本次改动范围。
...
[安装和更新发布说明](docs/UPDATES.md) · [改进方案](docs/DELAYED-PLAYBACK-PLAN-20260919.md) · [本次发布记录](docs/RELEASE-2.2.0-WORK.md)
